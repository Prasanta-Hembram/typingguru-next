...
const Hand = ({
  ...
  const keyListLeftHand = {
    ...
    middle_finger: ['#', '3', 'E', 'e', 'd', 'D', 'C', 'c'],
    ring_finger: ['@', '2', 'W', 'w', 's', 'S', 'X', 'x'],
    little_finger: [
      '~',
      '`',
      '!',
  ...
  const keyListRightHand = {
    ...
    middle_finger: ['*', '8', 'I', 'i', 'k', 'K', ',', '<'],
    ring_finger: ['(', '9', 'O', 'o', 'L', 'l', '.', '>'],
    little_finger: [
      ')',
      0,
      '_',
  ...
  return (
    ...
    >
      <LargePaths />
      {activeKey && keyList.thumb.indexOf(activeKey.key) !== -1 && (
        <path
          fill={color}
          strokeLinecap="butt"
      ...
      {activeKey && keyList.index_finger.indexOf(activeKey.key) !== -1 && (
        <path
          fill={color}
          strokeLinecap="butt"
          strokeLinejoin="miter"
      ...
      {activeKey && keyList.middle_finger.indexOf(activeKey.key) !== -1 && (
        <path
          fill={color}
          strokeLinecap="butt"
          strokeLinejoin="miter"
      ...
      {activeKey && keyList.ring_finger.indexOf(activeKey.key) !== -1 && (
        <path
          fill={color}
          strokeLinecap="butt"
          strokeLinejoin="miter"
